...
const uint32_t DEF_GOVERNANCE_ELIGIBILITY_PERIOD = 3600; // 1 Hour in seconds.
const uint32_t DEF_CANDIDATE_LIFE_PERIOD = 86400;        // 1 Day in seconds.
const uint32_t DEF_CANDIDATE_ELECTION_PERIOD = 3600;     // 1 Hour in seconds.
