...
// IOU Payment with single memo (Dereg).
uint8_t DE_REG_HOST_REBATE_PAYMENT[377] = {
    0x12, 0x00, 0x00,                   // transaction_type(ttPAYMENT)
    0x22, 0x80, 0x00, 0x00, 0x00,       // flags(tfCANONICAL)
    0x23, 0x00, 0x00, 0x00, 0x00,       // TAG_SOURCE
    0x24, 0x00, 0x00, 0x00, 0x00,       // sequence(0)
    ...
    0xF9, 0xEA, // Memo array and object start markers
    0x7C, 0x0F,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // MemoType (15 bytes) offset 176
    0x7D, 0x20,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // MemoData (32 bytes) offset 193
    0x7E, 0x0A,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // MemoFormat (10 bytes) offset 227
    0xE1, 0xF1,                                                 // Memo array and object end markers
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    ...
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 // emit_details(138) - Added on prepare to offset 239
    // emit_details - NOTE : Considered additional 22 bytes for the callback scenario.
};

#define DE_REG_HOST_REBATE_PAYMENT_TX_SIZE \
    sizeof(DE_REG_HOST_REBATE_PAYMENT)
#define PREPARE_DE_REG_HOST_REBATE_PAYMENT_TX(txid, evr_amount, to_address)       \
    {                                                                             \
        uint8_t *buf_out = DE_REG_HOST_REBATE_PAYMENT;                            \
        ...
        /* Copying the memo type */                                               \
        COPY_10BYTES((buf_out + 176), HOST_DE_REG_RES);                           \
        COPY_4BYTES((buf_out + 186), (HOST_DE_REG_RES + 10));                     \
        COPY_BYTE((buf_out + 190), (HOST_DE_REG_RES + 14));                       \
        /* Copying the memo data (txid) */                                        \
        COPY_32BYTES((buf_out + 193), txid);                                      \
        /* Copying the format (text/plain) */                                     \
        COPY_10BYTES((buf_out + 227), FORMAT_TEXT);                               \
        etxn_details((buf_out + 239), DE_REG_HOST_REBATE_PAYMENT_TX_SIZE);        \
        int64_t fee = etxn_fee_base(buf_out, DE_REG_HOST_REBATE_PAYMENT_TX_SIZE); \
        uint8_t *fee_ptr = buf_out + 84;                                          \
        CHECK_AND_ENCODE_FINAL_TRX_FEE(fee_ptr, fee);                             \
    }
...
// Mint URI Token
uint8_t REG_URI_TOKEN_MINT_TX[259] = {
    0x12, 0x00, 0x2D,                                     // transaction_type(ttURITokenMint)
    0x21, 0x00, 0x00, 0x53, 0x5A,                         // Network ID
    ...
    0x68, 0x40, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // fee - Added on prepare to offset 30
    0x73, 0x21, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    ...
    0x00, 0x00, 0x00, 0x00, 0x00, // uri(length 23, evrhost<tx_ide_ref>) - txid Added on prepare to offset 83
    0x81, 0x14, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, // account - Added on prepare to offset 101
     // emit details(138 bytes) - Added on prepare to offset 121
};
...
// Burn URI Token
uint8_t URI_TOKEN_BURN_TX[263] = {
    0x12, 0x00, 0x2E,                   // transaction_type(ttURITokenBurn)
    0x21, 0x00, 0x00, 0x53, 0x5A,       // Network ID (21338)
    0x24, 0x00, 0x00, 0x00, 0x00,       // sequence(0)
    ...
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // URITokenID - Added on prepare to offset 27
    0x68, 0x40, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,                               // fee - Added on prepare to offset 59
    0x73, 0x21, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // signing pubkey(NULL)
    0x81, 0x14, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, // account - Added on prepare to offset 105
     // emit details(138) - Added on prepare to offset 125
};
...
#define PREPARE_URI_TOKEN_BURN_TX(tknid)                              \
    {                                                                 \
        ...
        COPY_32BYTES((buf_out + 27), tknid);                          \
        COPY_20BYTES((buf_out + 105), hook_accid);                    \
        etxn_details((buf_out + 125), 138);                           \
        int64_t fee = etxn_fee_base(buf_out, URI_TOKEN_BURN_TX_SIZE); \
        uint8_t *fee_ptr = buf_out + 59;                              \
        CHECK_AND_ENCODE_FINAL_TRX_FEE(fee_ptr, fee);                 \
    }

// URI Token Sell Offer
uint8_t URI_TOKEN_SELL_OFFER[294] = {
    ...
    0x50, 0x24, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // URITokenID - Added on prepare to offset 27
    0x61, 0x40, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,                               // amount(<type(1)><amount(8)>) - Added on prepare to offset 59
    0x68, 0x40, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,                               // fee - Added on prepare to offset 68
    0x73, 0x21, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // signing pubkey(NULL)
    0x81, 0x14, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, // account_source(20) - Added on prepare to offset 114
    0x83, 0x14, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, // account_destination(20) - Added on prepare to offset 136
     // emit details(138) - Added on prepare to offset 156
};
...
#define PREPARE_URI_TOKEN_SELL_OFFER_TX(drops_amount_raw, to_address, tknid) \
    {                                                                        \
        ...
        UINT32_TO_BUF((buf_out + 21), cur_ledger_seq + 5);                   \
        COPY_32BYTES((buf_out + 27), tknid);                                 \
        uint8_t *buf_ptr = (buf_out + 59);                                   \
        _06_01_ENCODE_DROPS_AMOUNT(buf_ptr, drops_amount_raw);               \
        COPY_20BYTES((buf_out + 114), hook_accid);                           \
        COPY_20BYTES((buf_out + 136), to_address);                           \
        etxn_details((uint32_t)buf_out + 156, 138);                          \
        int64_t fee = etxn_fee_base(buf_out, URI_TOKEN_SELL_OFFER_TX_SIZE);  \
        uint8_t *fee_ptr = buf_out + 68;                                     \
        CHECK_AND_ENCODE_FINAL_TRX_FEE(fee_ptr, fee);                        \
    }

// Buy URI Token
uint8_t URI_TOKEN_BUY_TX[272] = {
    ...
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // signing pubkey(NULL)
    0x81, 0x14, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, // account - Added on prepare to offset 114
     // emit details(138) - Added on prepare to offset 134
};
