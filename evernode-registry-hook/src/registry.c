...
int64_t hook(uint32_t reserved)
{
    ...
    if (op_type != OP_NONE)
    {
        ...
        else if (op_type == OP_HOST_UPDATE_REG)
        {
            ...
            if (!IS_BUFFER_EMPTY_4((event_data + HOST_UPDATE_EMAIL_ADDRESS_PARAM_OFFSET)))
                COPY_4BYTES((token_id + HOST_EMAIL_ADDRESS_OFFSET), (event_data + HOST_UPDATE_EMAIL_ADDRESS_PARAM_OFFSET));
