...
#define PREPARE_EPOCH_REWARD_INFO(reward_info, moment_base_idx, moment_size, is_heartbeat, reward_pool_amount_ref, reward_quota_ref)                                                \
    {                                                                                                                                                                               \
        ...
        {                                                                                                                                                                           \
            ...
            if (float_compare(reward_pool_amount_ref, moment_reward_amount, COMPARE_LESS) == 1)                                                                                     \
            {                                                                                                                                                                       \
        ...
        reward_quota_ref = ((prev_moment_active_host_count > 0) ? float_divide(float_set(0, moment_reward_amount), float_set(0, prev_moment_active_host_count)) : float_set(0, 0)); \
    }
