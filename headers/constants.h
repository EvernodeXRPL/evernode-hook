...
// Constants
const uint32_t HOST_ADDR_VAL_SIZE = 114;
...
const uint32_t GOVERNANCE_INFO_VAL_SIZE = 58;
...
const uint32_t CANDIDATE_ID_VAL_SIZE = 84;
...
const uint32_t VOTER_BASE_COUNT_OFFSET = 3;
const uint32_t VOTER_BASE_COUNT_CHANGED_TIMESTAMP_OFFSET = 7;
const uint32_t FOUNDATION_LAST_VOTED_CANDIDATE_IDX = 15;
const uint32_t ELECTED_PROPOSAL_UNIQUE_ID_OFFSET = 17;
const uint32_t PROPOSAL_ELECTED_TIMESTAMP_OFFSET = 49;
const uint32_t UPDATED_HOOK_COUNT_OFFSET = 57;
...
const uint32_t CANDIDATE_SHORT_NAME_OFFSET = 22;
const uint32_t CANDIDATE_CREATED_TIMESTAMP_OFFSET = 42;
const uint32_t CANDIDATE_PROPOSAL_FEE_OFFSET = 50;
const uint32_t CANDIDATE_POSITIVE_VOTE_COUNT_OFFSET = 58;
const uint32_t CANDIDATE_NEGATIVE_VOTE_COUNT_OFFSET = 62;
const uint32_t CANDIDATE_LAST_VOTE_TIMESTAMP_OFFSET = 66;
const uint32_t CANDIDATE_STATUS_OFFSET = 74;
const uint32_t CANDIDATE_STATUS_CHANGE_TIMESTAMP_OFFSET = 75;
const uint32_t CANDIDATE_FOUNDATION_VOTE_STATUS_OFFSET = 83;
