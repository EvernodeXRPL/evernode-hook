...
#define NEW_HOOK_CAND_PREFIX "CandNewHook"
#define PILOTED_MODE_CAND_PREFIX "CandPilotedMode"
#define DUD_HOST_CAND_PREFIX "CandDudHost"
...
const uint32_t GOVERNANCE_INFO_VAL_SIZE = 62;
...
const uint32_t ELECTED_PROPOSAL_UNIQUE_ID_OFFSET = 21;
const uint32_t PROPOSAL_ELECTED_TIMESTAMP_OFFSET = 53;
const uint32_t UPDATED_HOOK_COUNT_OFFSET = 61;
