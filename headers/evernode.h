...
#define PREPARE_EPOCH_REWARD_INFO(reward_info, epoch_count, first_epoch_reward_quota, epoch_reward_amount, moment_base_idx, is_reputed, reward_pool_amount_ref, reward_amount_ref) \
    {                                                                                                                                                                              \
        ...
        {                                                                                                                                                                          \
            ...
            cur_moment_active_host_count = (is_reputed ? 1 : 0);                                                                                                                   \
